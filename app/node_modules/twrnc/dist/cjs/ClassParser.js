    ...
    parseUtility() {
        ...
        switch (this.char) {
            ...
            case `p`: {
                ...
                if (match) {
                    ...
                    const style = (0, spacing_1.default)(prop, spacingDirection, this.isNegative, this.rest, (_c = this.config.theme) === null || _c === void 0 ? void 0 : _c[prop]);
                    if (style)
                        return style;
                }
            }
        ...
        if (this.consumePeeked(`z-`)) {
            ...
            if (!Number.isNaN(zIndex)) {
                return (0, helpers_1.complete)({ zIndex });
            }
        }
